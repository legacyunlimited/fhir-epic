...
const PhysicianLogin = () => {
	...
	const physician_redirect_uri = physician_redirect_uri;
	// eslint-disable-next-line no-undef
	const physician_client_id = physician_client_id;
	// const audience =
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		const authLink = `${fhirServerBaseUrl}/oauth2/authorize?response_type=code&redirect_uri=${hysician_redirect_uri}&client_id=${physician_client_id}&aud=${audience}`;
